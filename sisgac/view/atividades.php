                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading text-center">
                            <span style="color:green; font-weight: bold; text-transform: uppercase;">Lista de Atividades</span>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <input type="hidden" name="id_atividades" id="id_atividades">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">                                                             
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tipo_atividade" id="tipo_atividade">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="ch_atividade">Carga Horária:</label>
                                    <input type="text" class="form-control" name="ch_atividade" id="ch_atividade">
                                </div>
                                <div class="text-area">
                                    <label for="descricao">Descrição:</label>
                                    <input type="<textarea id="descricao" name="descricao" rows="5" cols="10"></textarea>
                                </div>                                 
                            </div>
