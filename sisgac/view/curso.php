                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading text-center">
                            <span style="color:green; font-weight: bold; text-transform: uppercase;">Cursos</span>
                        </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">                                                             
                                ...
                                <div class ="form-group">
                                    <label for="nome">Carga Horária do Curso:</label>                                    
                                    <input type="text" class="form-control" name="ch_curso" id="ch_curso">
                                </div>
                            </div>
