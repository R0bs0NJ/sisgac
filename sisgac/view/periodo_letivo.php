...
<html lang="pt-BR">
    <head>    
        ...
        <!-- JS da página -->
        <script src="js/periodo_letivo.js"></script>
    </head>
    <body>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading text-center">
                            <span style="color:green; font-weight: bold; text-transform: uppercase;">Períodos Letivos</span>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <input type="hidden" name="id_periodo_letivo" id="id_periodo_letivo">
