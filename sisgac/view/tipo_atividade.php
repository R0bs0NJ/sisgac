                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading text-center">
                            <span style="color:green; font-weight: bold; text-transform: uppercase;">Tipos de atividades</span>
                        </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Informações das atividades</h4>
                            ...
                            <div class="modal-body">                                                             
                                ...
                                <div class="form-group">
                                    <label for="nome">Carga horária máxima:</label>
                                    <input type="text" class="form-control" name="ch_maxima" id="ch_maxima">
                                </div>
                                <div class="form-group">
                                    <label for="nome">Carga horária mínima:</label>
                                    <input type="text" class="form-control" name="ch_minima" id="ch_minima">
                                </div>
                            </div>
