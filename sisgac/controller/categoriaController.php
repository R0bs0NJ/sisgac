...
class categoriaController {
    ...
    public function listar() {        
        ...
        $ordenacao = array('categoria.descricao'=>'ASC');
        ...
        $result = $this->categoriaM->listar($parametros,$ordenacao,$limit);
        ...
        if ($total_linhas > 0) {       
            ...
            $tabela .= '<thead>';
            $tabela .= '<tr>';
            $tabela .= '<th width="90%">Descrição</th>';
            ...
            while ($linha = mysqli_fetch_assoc($result)) {
                ...
                $tabela .= '<td>';
                $tabela .= '<a href="#void" onclick="abrirModal(' . "'modal_formulario','atualizar'," . $linha['id_categoria'] . ')" style="color:green">';
                $tabela .= '<span class="glyphicon glyphicon-edit"></span>';
                $tabela .= '</a>';
                $tabela .= '</td>';

                $tabela .= '<td>';
                $tabela .= '<a href="#void" onclick="abrirModal(' . "'modal_confirmacao','deletar'," . $linha['id_categoria'] . ')" style="color:red">';
        ...
        $resultado = $this->categoriaM->listar($parametros,$ordenacao);
    ...
    public function getCategoriaId() {
        $res = $this->categoriaM->getCategoriaId($_POST['id_categoria']);
    ...
    public function deletar() {       
        ...
        if (isset($_POST['id_categoria'])) {
            $res = $this->categoriaM->deletar($_POST['id_categoria']);
            if ($res) {
    ...
    public function inserir() {
        ...
        if ($this->formularioValido()) {
            ...
            $res = $this->categoriaM->inserir($_POST);
            if ($res) {
                $this->msg .= '<div class="alert alert-success">';
        ...
        $resposta = array('resultado' => $resultado, 'msg' => $this->msg, 'id_categoria' => $id_categoria);
        return json_encode($resposta);
    }    
    ...
    public function atualizar() {
        ...
        if ($this->formularioValido()) {
            ...
            $res = $this->categoriaM->atualizar($_POST);
            if ($res) {
                $this->msg .= '<div class="alert alert-success">';
